...
| BE   | [5만건 데이터, 1500ms -> 160ms로 4단계 개선된 핵심로직](https://github.com/softeer5th/Team2-Getit/wiki/%ED%95%B5%EC%8B%AC-%EC%A1%B0%ED%9A%8C-%EB%A1%9C%EC%A7%81-1,500ms-%EC%97%90%EC%84%9C-160ms-%EA%B0%9C%EC%84%A0)              | 송민규             |
