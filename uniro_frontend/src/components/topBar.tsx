...
const TopBar = () => {
	...
	return (
		<AnimatePresence>
			<motion.div
				className="absolute top-0 z-10 max-w-[450px] w-full min-h-[143px] bg-gray-100 pt-[16px] pb-5 px-[29px] flex flex-col items-center justify-center rounded-b-4xl shadow"
				initial={{ y: -143 }}
				animate={{ y: 0 }}
				exit={{ y: -143 }}
